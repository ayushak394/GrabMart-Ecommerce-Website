          ...
          <div className="hidden lg:flex flex-col justify-center space-y-8 animate-in fade-in slide-in-from-left-8 duration-1000">
            <div className="space-y-4">
              ...
              <p className="text-xl text-muted-foreground max-w-md leading-relaxed">
                Welcome back to your favorite shopping destination. Sign in to
                access your account and enjoy exclusive deals.
              </p>
            </div>
            ...
            <div className="space-y-6">
              {[
                ...
                { icon: "⚡", title: "Fast Checkout", desc: "Quick and easy" },
                {
                  icon: "🎁",
                  title: "Exclusive Deals",
                  desc: "Members only offers",
                },
              ].map((feature, idx) => (
                <div
                  key={idx}
